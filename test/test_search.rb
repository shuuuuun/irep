...
class TestSearch < Test::Unit::TestCase
  ...
  def test_find_directory
    ...
    search = Irep::Search.new path: @tmp_dir, search_text: 'test_find_directory'
  ...
  def test_find_filename
    ...
    search = Irep::Search.new path: @tmp_dir, search_text: 'test_find_filename'
  ...
  def test_find_in_file
    ...
    search = Irep::Search.new path: @tmp_dir, search_text: 'test'
