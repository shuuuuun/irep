...
module Irep
  module Replace
    ...
    def replace_interactively(search_results, search_text, replace_text)
      listened_results = listen_if_replace(search_results, search_text, replace_text)
    ...
    def listen_if_replace(results, search_text, replace_text)
      ...
      results.each do |result|
        result_preview = result.preview.gsub(search_text, replace_text)
        interface.listen(
          path: result.path,
